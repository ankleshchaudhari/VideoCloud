...
export async function GET()
{
    try{
        ...
        const videos= await Video.find({}).sort({createdAt:-1}).lean() //find: get all videos from document, sort: newest first (-1 means descending order → newest first), lean: convert document into js objectsreturn plain JS objects
